...
public class CASA extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        TextView view = (TextView) findViewById(R.id.textView33);
        ImageView view1 = (ImageView) findViewById(R.id.imageView4);
        ...
        } else if (id == R.id.nav_examen_ingles) {
            fragment = new InglesFragment();
            fragmentoSeleccionado = true;


        } else if (id == R.id.nav_constancias) {
            fragment = new ConstanciasFragment();
            fragmentoSeleccionado = true;
