 ...
 * {@link BajaMateria.OnFragmentInteractionListener} interface
...
public class BajaMateria extends Fragment {
    ...
    public static BajaMateria newInstance(String param1, String param2) {
        BajaMateria fragment = new BajaMateria();
